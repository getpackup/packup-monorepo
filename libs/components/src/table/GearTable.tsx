// Copy of Table.tsx as it was before i started working on things, will delete soon
// TODO
// import {
//   ActivityTypes,
//   allGearListItems,
...
// import { GearClosetType } from '@getpackup-group/common'
...
//   const fetchedGearCloset: GearClosetType[] = useSelector(
//     (state: AppState) => state.firestore.ordered['gearCloset']
//   )
//   const profile = useSelector((state: AppState) => state.firebase.profile)

//   const gearClosetCategories: string[] = fetchedGearCloset?.[0]?.categories ?? []
...
// export const GearTable: FunctionComponent<TableProps> = ({
//   columns,
//   data,
//   hasPagination,
//   hasSorting,
