...
import { baseBorderStyle, brandInfo, brandPrimary, halfSpacer, lightestGray } from '@packup/styles'
...
const firebaseConnection = (firebase: ExtendedFirebaseInstance, tripId: string, itemId: string) =>
  firebase.firestore().collection('trips').doc(tripId).collection('packing-list').doc(itemId)
